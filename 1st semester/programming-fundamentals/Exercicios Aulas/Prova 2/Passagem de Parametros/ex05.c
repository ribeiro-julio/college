...
void preencherBandas(Banda bandas[5]){
    int i;
    printf("--------------------------\n");
    for(i = 0; i < 5; i++){
...
void pesquisaRanking(Banda bandas[5]){
    int ranking, i;
    printf("--------------------------\n");
...
void pesquisaEstilo(Banda bandas[5]){
    char estilo[30];
    int i, ocorrencias = 0;
    printf("--------------------------\n");
...
void pesquisaNome(Banda bandas[5]){
    char banda[30];
    int i, encontrou;
    printf("--------------------------\n");
...
int main(){
    ...
    do{
        ...
        switch(opcao){
            ...
            case 2: 
                system("cls");
                pesquisaRanking(bandas);
                break;
            case 3: 
                system("cls");
                pesquisaEstilo(bandas);
                break;
            case 4: 
                system("cls");
                pesquisaNome(bandas);

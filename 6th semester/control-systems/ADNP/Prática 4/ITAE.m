...
theta = 2;
%Controlador PI
Kp_PI = (0.586/K)*((tau/theta)^0.916)
Ti_PI = tau/(1.03-(0.165*(theta/tau)))
Cs_PI = Kp_PI + (Kp_PI/(Ti_PI*s))
SIC_004_PI = SIC_004*Cs_PI
SIC_004_PI_MF = feedback(SIC_004_PI, 1)
%Controlador PID
Kp_PID = (0.965/K)*((tau/theta)^0.850)
Ti_PID = tau/(0.796-(0.147*(theta/tau)))
Td_PID = 0.308*tau*((theta/tau)^0.929)
